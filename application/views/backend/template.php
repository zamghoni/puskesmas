...
<head>
  ...
  <!-- lightbox -->
	...
	<title>Puskesmas Penjaringan - <?=$subpage.' '.$page?></title>
</head>
        ...
        <li class="<?=activate_menu('dashboard')?>">
				...
				<li class="<?=activate_menu('diagnosa')?>">
					<a href="<?=site_url('diagnosa')?>">
						...
						<div class="menu-title">Hasil Diagnosa</div>
					</a>
				</li>
				<li class="dropdown-divider mb-0 mt-2"></li>
